...
#fit the model
utils.fit_model(model,generatordata,epocs = 1000, samples_per_epoch=200, nb_val_samples=10,early_stopping=True, patience=5)
weights_path = 'weights.h5'
model.load_weights(weights_path, by_name = True)
#make a prediction on the test image
utils.predict_image_categorical_tile(model,test_img,tilesize=img_rows, outputimg = "prediction.tif")
print("accuracy : "+str(utils.evaluate("./prediction.tif",test_label_img)))
